...
<div style="width: 60%; margin-left: 20%; padding-top: 10px;">
    <div class="mb-3">
        <label for="titlebox" class="form-label">게시글 제목</label>
        <input type="text" class="form-control" name="title" id="brd-name" placeholder="여기에 제목을 입력하세요">
        <label><input type="checkbox" id="priv" value="private"> 비밀글</label>
    </div>
    <div class="mb-3">
        <textarea class="form-control" id="brd-content" name="content" rows="8"></textarea>
    </div>
    <button type="button" class="btn btn-primary" id="brd-write">글쓰기</button>
</div>
